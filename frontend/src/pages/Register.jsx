...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-bg p-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/5 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[radial-gradient(circle,rgba(167,139,250,0.06)_0%,transparent_70%)] pointer-events-none" />

      <div className="w-full max-w-[420px] relative animate-in">
        {/* Header */}
        <div className="text-center mb-10">
          <Link to="/" className="inline-block hover:opacity-80 transition-opacity">
            <div className="w-14 h-14 bg-gradient-to-br from-purple to-primary rounded-lg flex items-center justify-center text-2xl mx-auto mb-5 shadow-glow">
              ✨
            </div>
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="mb-6">
              ...
              <input
                ...
                autoComplete="new-password"
              />
              {errors.confirmPassword && <p className="text-[0.78rem] text-danger mt-1.25">{errors.confirmPassword}</p>}
            </div>
            ...
            <button
              ...
              disabled={loading}
            >
              {loading ? <><span className="spinner mr-2" /> Creating account…</> : '→ Register'}
            </button>
          </form>
